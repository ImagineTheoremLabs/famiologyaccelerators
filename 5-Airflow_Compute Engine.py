...
def main():
    ...
    The Compute Engine is designed to streamline and simplify file preprocessing workflows. Whether you're dealing with large datasets, complex transformations, or repetitive tasks, this engine provides the tools you need to efficiently prepare your data for analysis.
    </div>
    """, unsafe_allow_html=True)
...
div>
    ...
    st.markdown("""
    <div class='markdown-text'>
    - The Compute Engine is go-to solution for simplifying file preprocessing workflows. With its powerful features and ease of use, you'll be able to focus more on analyzing your data and less on preparing it.
    </div>
    """, unsafe_allow_html=True)
